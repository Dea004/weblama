...
<div class="w-full max-w-3xl mx-auto">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            <div class="relative w-full h-96 overflow-hidden rounded-lg">
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/img/RumaRasa/ruma1.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma2.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma3.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma4.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma5.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma6.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma7.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/RumaRasa/ruma8.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
        ...
        <div class="container mx-auto mt-8 px-4">
            <div class="flex gap-6">
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p><strong>Sabtu - Minggu:</strong> 12.00 - 21.00 WITA</p>
                    <p><strong>Senin - Jumat:</strong> 08.30 - 22.30 WITA</p>
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p>Nikmati Hidangan Mulai dari <strong>Rp23.000</strong></p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 w-full">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.399981686588!2d115.2236031!3d-8.653455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
                1!3m3!1m2!1s0x2dd241f62bc18473%3A0xca8fb29696387a63!2sRumarasa%20Bali!5e0!3m2!1sid!2sid!4v1732683836921!5m2!1sid!2sid" 
    ...
    let jamBuka, menitBuka, jamTutup, menitTutup;
    
    if (hariSekarang === 0 || hariSekarang === 6) { // Sabtu (6) dan Minggu (0)
        jamBuka = 12; // Jam buka 12:00
        menitBuka = 0;
        jamTutup = 21; // Jam tutup 21:00
        menitTutup = 0;
    } else { // Senin - Jumat
        jamBuka = 8;  
        menitBuka = 30;
    ...
    if (
        ...
        (jamSekarang < jamTutup || (jamSekarang === jamTutup && menitSekarang <= menitTutup))
    ) {
        pesanOperasional.textContent = "RumaRasa Bali sedang BUKA";
        pesanOperasional.classList.add('text-green-500');
        pesanOperasional.classList.remove('text-red-500');
    } else {
        pesanOperasional.textContent = "RumaRasa Bali sedang TUTUP";
    ...
    window.onload = cekJamOperasional;
        ...
        Swal.fire({
        title: "Berhasil!",
        text: "RumaRasa Bali telah ditambahkan ke daftar favorite!",
        icon: "success"
        });
    }
    </script>
