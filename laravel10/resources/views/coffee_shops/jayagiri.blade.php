...
<div class="w-full max-w-3xl mx-auto">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            <div class="relative w-full h-96 overflow-hidden rounded-lg">
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/img/Jayagiri/jayagiri1.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Jayagiri/jayagiri2.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Jayagiri/jayagiri3.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Jayagiri/jayagiri4.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Jayagiri/jayagiri5.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Jayagiri/jayagiri6.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
        ...
        <div class="container mx-auto mt-8 px-4">
            <div class="flex gap-6">
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p><strong>Setiap Hari:</strong> 09.00 - 21.00 WITA</p>
        ...
        <div class="mb-4 w-full">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.292305057853!2d115.22537517359677!3d-8.663726188164818!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
                1!3m3!1m2!1s0x2dd2419b5f2a02ad%3A0xd5d294825024554a!2sJayagiri%20Coffee!5e0!3m2!1sen!2sid!4v1729358367818!5m2!1sen!2sid" 
    ...
    function cekJamOperasional() {
        ...
        pesanOperasional.textContent = "JayagiriCoffee sedang BUKA";
        pesanOperasional.classList.add('text-green-500');
        } else {
        pesanOperasional.textContent = "JayagiriCoffee sedang TUTUP";
    ...
    window.onload = cekJamOperasional;
        ...
        Swal.fire({
        title: "Berhasil!",
        text: "Jayagiri Coffee telah ditambahkan ke daftar favorite!",
        icon: "success"
        });
    }
    </script>
