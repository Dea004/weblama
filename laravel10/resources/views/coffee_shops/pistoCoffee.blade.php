...
<div class="w-full max-w-3xl mx-auto">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            <div class="relative w-full h-96 overflow-hidden rounded-lg">
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/img/Pisto/pisto1.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
        ...
        <div class="container mx-auto mt-8 px-4">
            <div class="flex gap-6">
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p><strong>Setiap Hari:</strong> 09.00 - 00.00 WITA</p>
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p>Nikmati Hidangan Mulai dari <strong>Rp18.000</strong></p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 w-full">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.115017830408!2d115.237779!3d-8.680611199999989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
                1!3m3!1m2!1s0x2dd241f050560d0b%3A0x2dcdf064a5f0314e!2sPisto%20Coffee!5e0!3m2!1sid!2sid!4v1732683533813!5m2!1sid!2sid" 
    ...
    function cekJamOperasional() {
        ...
        pesanOperasional.textContent = "Pisto Cooffe & Eatery sedang BUKA";
        pesanOperasional.classList.add('text-green-500');
        } else {
        pesanOperasional.textContent = "Pisto Cooffe & Eatery sedang TUTUP";
    ...
    window.onload = cekJamOperasional;
        ...
        Swal.fire({
        title: "Berhasil!",
        text: "Pisto Cooffe & Eatery telah ditambahkan ke daftar favorite!",
        icon: "success"
        });
    }
    </script>
