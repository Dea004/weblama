...
<div class="w-full max-w-3xl mx-auto">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            <div class="relative w-full h-96 overflow-hidden rounded-lg">
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/img/Atera/atera1.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera2.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera3.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera4.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera5.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera6.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera7.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera8.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Atera/atera9.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
        ...
        <div class="container mx-auto mt-8 px-4">
            <div class="flex gap-6">
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p><strong>Setiap Hari:</strong> 07.30 - 22.30 WITA</p>
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p>Nikmati Hidangan Mulai dari <strong>Rp20.000</strong></p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 w-full">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.2840902089756!2d115.23857389999999!3d-8.664509299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
                1!3m3!1m2!1s0x2dd2410020ff625d%3A0x9b7e83edb56adc8d!2sAtera%20Coffee!5e0!3m2!1sid!2sid!4v1732682071838!5m2!1sid!2sid" 
    ...
    function cekJamOperasional() {
        ...
        pesanOperasional.textContent = "Atera Coffee sedang BUKA";
        pesanOperasional.classList.add('text-green-500');
        } else {
        pesanOperasional.textContent = "Atera Coffee sedang TUTUP";
    ...
    window.onload = cekJamOperasional;
        ...
        Swal.fire({
        title: "Berhasil!",
        text: "Atera Coffee telah ditambahkan ke daftar favorite!",
        icon: "success"
        });
    }
    </script>
