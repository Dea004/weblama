...
<div class="w-full max-w-3xl mx-auto">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            <div class="relative w-full h-96 overflow-hidden rounded-lg">
                <div class="duration-700 ease-in-out" data-carousel-item="active">
                    <img src="/img/Tahoma/tahoma1.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma2.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma3.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma4.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma5.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma6.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/img/Tahoma/tahoma7.jpg" class="absolute block w-full h-auto object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                </div>
            </div>
        ...
        <div class="container mx-auto mt-8 px-4">
            <div class="flex gap-6">
                ...
                <div class="bg-white p-6 shadow-md rounded-md w-1/3">
                    ...
                    <p><strong>Setiap Hari:</strong> 00.00 - 00.00 WITA</p>
        ...
        <div class="mb-4 w-full">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3943.914010493482!2d115.18084749999998!3d-8.699716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.
                1!3m3!1m2!1s0x2dd247900c24606f%3A0xdf8d613a3f554cfa!2sTahoma%20Cafe%20%26%20Eatery!5e0!3m2!1sid!2sid!4v1732682364440!5m2!1sid!2sid" 
    ...
    function cekJamOperasional() {
        ...
        pesanOperasional.textContent = "Tahoma Coffee sedang BUKA";
        pesanOperasional.classList.add('text-green-500');
        } else {
        pesanOperasional.textContent = "Tahoma Coffee sedang TUTUP";
    ...
    window.onload = cekJamOperasional;
        ...
        Swal.fire({
        title: "Berhasil!",
        text: "Tahoma Coffee telah ditambahkan ke daftar favorite!",
        icon: "success"
        });
    }
    </script>
